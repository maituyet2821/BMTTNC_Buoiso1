...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_3.setGeometry(QtCore.QRect(30, 200, 47, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.txt_plain_text.setGeometry(QtCore.QRect(110, 70, 571, 101))
        self.txt_plain_text.setObjectName("txt_plain_text")
        self.txt_cipher_text = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(110, 260, 571, 101))
        self.txt_cipher_text.setObjectName("txt_cipher_text")
        self.txt_key = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(110, 200, 571, 31))
        self.txt_key.setObjectName("txt_key")
        self.btn_encrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_encrypt.setGeometry(QtCore.QRect(170, 420, 75, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.btn_encrypt.setFont(font)
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(480, 420, 75, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
